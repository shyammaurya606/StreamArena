        ...
        <div className="max-w-5xl">
            ...
            <div className="col-span-1 md:col-span-2 lg:col-span-3 bg-surface-container-lowest rounded-xl p-7 ring-2 ring-primary relative overflow-hidden">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-7">
                <div className="flex items-center gap-5">
                  <div className="w-20 h-14 rounded-lg overflow-hidden shadow-sm border border-outline-variant/20 bg-gradient-to-r from-orange-500 via-white to-green-600 flex-shrink-0"></div>
                  <div>
                    <h3 className="font-headline text-2xl font-bold tracking-tight">India</h3>
                    <p className="font-label text-xs text-on-surface-variant">12 Cricket Channels Active</p>
                  </div>
                </div>
            ...
            <div className="bg-surface-container-lowest rounded-xl p-6 hover:-translate-y-1 transition-all duration-300 cursor-pointer group shadow-sm border border-outline-variant/10">
              <div className="flex items-center gap-4 mb-5">
                ...
                <div>
                  ...
                  <p className="font-label text-[10px] text-on-surface-variant uppercase">8 CRICKET CHANNELS</p>
                </div>
              </div>
            ...
            <div className="bg-surface-container-lowest rounded-xl p-6 hover:-translate-y-1 transition-all duration-300 cursor-pointer group shadow-sm border border-outline-variant/10">
              <div className="flex items-center gap-4 mb-5">
                ...
                <div>
                  ...
                  <p className="font-label text-[10px] text-on-surface-variant uppercase">6 CRICKET CHANNELS</p>
                </div>
              </div>
              <div className="space-y-2 opacity-60 group-hover:opacity-100 transition-opacity">
                <div className="flex justify-between items-center text-sm border-b border-surface-container-high pb-2">
            ...
            <div className="bg-surface-container-lowest rounded-xl p-6 hover:-translate-y-1 transition-all duration-300 cursor-pointer group shadow-sm border border-outline-variant/10">
              <div className="flex items-center gap-4 mb-5">
                ...
                <div>
                  ...
                  <p className="font-label text-[10px] text-on-surface-variant uppercase">5 CRICKET CHANNELS</p>
                </div>
              </div>
              <div className="space-y-2 opacity-60 group-hover:opacity-100 transition-opacity">
                <div className="flex justify-between items-center text-sm pb-2">
          ...
          <div className="mt-20 mb-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <div className="md:col-span-2 bg-primary p-8 rounded-2xl flex flex-col justify-between min-h-[260px] relative overflow-hidden group">
              ...
              <div className="bg-surface-container-highest p-7 rounded-2xl flex flex-col justify-between">
                <span className="material-symbols-outlined text-4xl text-red-600" style={{fontVariationSettings: "'FILL' 1"}}>sports_soccer</span>
                <div><h4 className="font-headline text-lg font-bold mb-1">Supersport</h4><p className="text-xs text-on-surface-variant">Sub-Saharan Africa's premier sports broadcaster.</p></div>
              </div>
              <div className="bg-surface-container-highest p-7 rounded-2xl flex flex-col justify-between border-2 border-primary">
                <span className="material-symbols-outlined text-4xl text-red-600" style={{fontVariationSettings: "'FILL' 1"}}>sports_cricket</span>
                <div><h4 className="font-headline text-lg font-bold mb-1">Willow TV</h4><p className="text-xs text-on-surface-variant">The leading cricket broadcaster in North America.</p></div>
              </div>
            </div>
          </div>
        </div>
